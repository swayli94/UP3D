"""Track V V5 Stage 2 -- the J_BL,phi block (binding: phases/p1/docs/roadmap/
...
FD protocol mirrors the Stage-1 gate (tests/A/test_A44_tight_jacobian.py):
...
only, the tests/A/test_A42_loose_coupling.py:204 precedent; the closure-packet
