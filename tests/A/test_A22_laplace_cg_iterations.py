...
from tests.C.test_C01_laplace_mms import phi_exact_fn
...
class TestCGIterationArtifacts:
    ...
    def test_export_cg_convergence_overlay(self, tmp_path):
        import matplotlib
        matplotlib.use("Agg")
        ...
        output_file = tmp_path / "cg_convergence_overlay.png"
