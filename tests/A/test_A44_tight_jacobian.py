...
3.0e6, x_tr 0.05/0.05 -- the GV3.1 configuration, coarse recorded):
  ...
  - G (the phi -> u_e recovery operator) vs edge_velocity_per_zone on a
    ...
    machine precision;
  - the J_phi,BL FD gate (the B19/B31/V1 pattern, tests/A/test_A35_ibl3_core.py:
    84-109, tests/A/test_A41_transpiration_newton_rhs.py:141-180): state point =
...
only, the tests/A/test_A42_loose_coupling.py:204 precedent; the cheap operator
