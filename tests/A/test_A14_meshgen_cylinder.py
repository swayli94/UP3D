...
mesh which is the actual M0 deliverable (tests/A/test_A15_meshgen_naca0012.py).
...
class TestCylinderArtifacts:
    ...
    def test_export_m0_cylinder_cp(self, tmp_path, mesh_dir):
        import matplotlib
        matplotlib.use("Agg")
        ...
        out_png = tmp_path / "cylinder_cp.png"
