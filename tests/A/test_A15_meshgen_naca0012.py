...
def meshes(request):
    ...
    mesh_dir = REPO_ROOT / "cases" / "meshes" / "naca0012_2.5d"
...
class TestNacaNonliftingSolve:
    ...
    def test_alpha0_solve_and_spanwise(self, meshes):
        ...
        from tests.A.test_A14_meshgen_cylinder import element_gradients_all
        ...
        # split (see tests/A/test_A14_meshgen_cylinder.py docstring; measured 5.4e-2)
...
class TestNacaArtifacts:
    ...
    def test_export_m0_naca_edge_histogram(self, tmp_path, meshes):
        import matplotlib
        matplotlib.use("Agg")
        ...
        out_png = tmp_path / "edge_length_histogram.png"
        fig.savefig(out_png, dpi=150, bbox_inches="tight")
        plt.close(fig)
        assert out_png.exists()

        with open(tmp_path / "summary.csv", "w") as f:
