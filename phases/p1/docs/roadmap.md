...
- **V — viscous coupling** — [roadmap/track_v.md](roadmap/track_v.md) — designed 2026-07-09/10 · **V1 ✓ CLOSED 2026-07-22**
  ...
  tol = max(1e-10, 10·κ₁·eps), ~4-decade margin — VERDICT §3); the amended seeds sit INSIDE the 10×
...
[design.md](../../../docs/design.md) remains the design reference for equations, numerics and
...
snapshot + document map: [overview.md](../../../docs/overview.md). Analysis/review reports
