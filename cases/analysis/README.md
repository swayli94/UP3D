...
| `c1_ls_jacobian_fd/` | **A3 / GA3.5** — is the LS Newton Jacobian exact on a 3D mesh? (kimi code-review C1) | `python cases/analysis/c1_ls_jacobian_fd/run_check.py` | ~4 min |
