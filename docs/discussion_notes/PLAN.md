...
Track P:  P0 ✓ → P1 △ → P2 ✓ → P3 ✓ → P4 ✓ → P5 ✓ → P6 ✓ → P7 ✓ → P8 ✓ → P9 ◐ → P10 ☐ → P11 ☐ → P12 ☐
                                                                    ↑
Track B:  B1 ✓ → B2 ✓ → B3 ✓ → B4 ✓ → B5 ✓ → B6 ☐ → B7 ☐ → B8 ☐   [B9 搁置]
...
> **⚠️ 2026-07-12 两次 Track-B 重编号**：新插入 B4（TE 控制体），随后取消半整数编号。净映射：远场 A/B（曾 B3.5→B4.5）→ **B5**；旧 B4 跨声速 → **B6**；旧 B4.5 M6 3D → **B7**；旧 B5 多尾流 → **B8**；旧 B6 曲线尾流 → **B9**。以 roadmap 为准。
