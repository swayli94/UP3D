...
>
> **⚠ Track-P 重编号（2026-07-11，用户指示）**：新增 **P9 = 网格收敛/精度缺口判别**
> （证据阶段：G9.1 M6 三点 Richardson 外推、G9.2 2.5D 尖后缘升力 oracle、G9.3 归因
> 裁决），原 P9（曲面壁面单元）→ **P10**、原 P10（Backlog）→ **P11**。本文件下文
> 各节仍用旧编号（"P9 曲面单元" 应读作 P10，"P10 Backlog" 应读作 P11）；细节以
> roadmap.md 为准。
...
| **Track P** — 势流求解器 | FPE 的准确、高效求解 | P0–P8 已关闭；P9（判别）进行中；P10–P11 待开发 |
...
Track M:  M0 ✓ → M1 ✓ → M2 ☐
                      Ↄ (为 P/B/V 提供网格)
Track P:  P0 ✓ → P1 △ → P2 ✓ → P3 ✓ → P4 ✓ → P5 ✓ → P6 ✓ → P7 ✓ → P8 ✓ → P9 ◐ → P10 ☐ → P11 ☐
                                                                    ↑
