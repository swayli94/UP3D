...
not started** (design summary in design.md §11 / Track V section below) — see
their sections after Track P.
...
`git show 8aa4aee:docs/discussion_notes/<file>`. **This file is authoritative
for phase status and gates.**)
