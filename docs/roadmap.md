...
(B1 ✓ B2 ✓ B3 ✓ B4 ✓ B4.5 ✓ as of 2026-07-12, next B5; numerics spec
...
## Track B — Level-set embedded wake (designed 2026-07-07; IN PROGRESS — B1 ✓ B2 ✓ B3 ✓ B4 ✓ B4.5 ✓ as of 2026-07-12)
...
the TE's **WALL-ADJACENT** upper/lower control volumes. **B4.5 closed
...
2–4× larger domain; M6 leg folded into B5.5). Next = B5 (transonic) / B5.5
(M6 3D).
...
### B4.5 — Far-field A/B: Dirichlet+vortex vs Neumann outlet ✓ (was B3.5; NEW 2026-07-11; closed 2026-07-12, user-arbitrated)
...
- [ ] **medium runs M0.7875** (the G8.1 re-specced case — M0.80 medium has no reachable isolated solution)
...
Track status: **◐ IN PROGRESS** — design 2026-07-07; B6 shelved 2026-07-10;
