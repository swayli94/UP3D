...
(B1 ✓ B2 ✓ B3 ✓ B4 ✓ B5 ✓ as of 2026-07-12, next B6; numerics spec
...
## Track B — Level-set embedded wake (designed 2026-07-07; IN PROGRESS — B1 ✓ B2 ✓ B3 ✓ B4 ✓ B5 ✓ as of 2026-07-12)
...
### B6 — Transonic + Mach continuation on the level-set path ☐ (was B5, orig B4)
