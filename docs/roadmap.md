...
## Track B — Level-set embedded wake (designed 2026-07-07; IN PROGRESS — B1 ✓ B2 ✓ B3 ✓ B4 ✓ as of 2026-07-12)
...
the TE's **WALL-ADJACENT** upper/lower control volumes. Next = B4.5 (far-field
A/B) / B5 (transonic).
