...
| **Track B** B15 LS Newton ramp + freeze | `cases/demo/b15_ls_newton_ramp/` | 19/19 at close-out; **17/20 under the first B20 re-baseline; M0.84 capability RESTORED by B21 (2026-07-19)** | closed 2026-07-15 (plateau gone, 3.5×; four errata). ★ Erratum trail: the post-B20 stall (GB20.7 "real capability loss") was actually the B21/N1 freeze-capture patch gap — with it fixed the committed recipe reaches M0.84 again (γ 0.088343, res 9e-14, 515 s); see the B21 section | [track_b](demo_report/track_b.md) |
