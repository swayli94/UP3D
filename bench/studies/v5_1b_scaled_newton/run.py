...
Run:  python bench/studies/v5_1b_scaled_newton/run.py
      python bench/studies/v5_1b_scaled_newton/run.py --levels coarse
      python bench/studies/v5_1b_scaled_newton/run.py --no-k1
