...
Binding text: bench/studies/v5_1d_near_band_window/PRE_REGISTRATION.md
...
Run:  python bench/studies/v5_1d_near_band_window/run.py
      python bench/studies/v5_1d_near_band_window/run.py --levels coarse
