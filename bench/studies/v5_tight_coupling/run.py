...
coupling defect. Amended protocol per Addendum 2:
  ...
  6. gv5_1_compare.csv + summary.csv: N_polish and the honest total
     ...
     5 medium, READ from bench/studies/v3_loose_coupling/results/,
...
Run:  python bench/studies/v5_tight_coupling/run.py --levels coarse
      python bench/studies/v5_tight_coupling/run.py --levels medium
"""
