...
- GV6.0 ruling (user 2026-07-25,
  `phases/p1/cases/analysis/v6_0_design_adjudication/DESIGN_ADJUDICATION.md` §6):
...
- GV6.1 ✓ CLOSED (6 PASS / 0 FAIL / 7 RECORDED,
  `bench/studies/v6_1_wake_sheet/VERDICT.md`): the non-binding on/off
  ...
  meaningful.
- A4 (`phases/p1/cases/analysis/a4_ue_error_band/VERDICT.md`): the medium
