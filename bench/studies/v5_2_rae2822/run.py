...
Pre-registered (bench/studies/v5_2_rae2822/PRE_REGISTRATION.md, committed
...
Run:  python bench/studies/v5_2_rae2822/run.py
"""
...
gv3 = _load("gv3_run", "bench/studies/v3_loose_coupling/run.py")
